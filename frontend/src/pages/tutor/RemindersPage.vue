...
const role = computed<Role>(() => (auth.role ?? 'tutor') as Role)
  ...
  <div class="page">
    <div>
      ...
      <p class="muted" style="margin: 8px 0 0 0;">
        Уведомления о просроченных заданиях и событиях расписания.
      </p>
    </div>
    ...
    <div class="card">
      <div class="row">
        <div>
          ...
          <div class="muted">Нажмите «Готово», чтобы отметить как выполненное</div>
        </div>
